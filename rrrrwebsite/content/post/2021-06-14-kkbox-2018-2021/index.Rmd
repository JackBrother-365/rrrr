...
draw <- function(path, language){
  ...
  if (language == "ch"){
    # 將正負情緒詞語讀入
    positive <- unique(read_csv("../../../../R_project_Patrick/positive.txt"))
    negative <- unique(read_csv("../../../../R_project_Patrick/negative.txt"))
...
song2021 <- draw("../../../../R_project_Patrick/kkbox/song1.csv", "ch")
song2020 <- draw("../../../../R_project_Patrick/kkbox/song2.csv", "ch")
song2019 <- draw("../../../../R_project_Patrick/kkbox/song3.csv", "ch")
song2018 <- draw("../../../../R_project_Patrick/kkbox/song4.csv", "ch")
song_en2021 <- draw("../../../../R_project_Patrick/kkbox/english1.csv", "en")
song_en2020 <- draw("../../../../R_project_Patrick/kkbox/english2.csv", "en")
song_en2019 <- draw("../../../../R_project_Patrick/kkbox/english3.csv", "en")
song_en2018 <- draw("../../../../R_project_Patrick/kkbox/english4.csv", "en")
...
ggplot(data = years) +
  ...
  ggtitle(label = "kkbox 2018~2021 positive and negative sentiment")
```
